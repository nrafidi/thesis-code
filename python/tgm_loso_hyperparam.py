...
if __name__ == '__main__':
    ...
    for sen_type in ['active', 'passive']:
        ...
        plt.savefig(fig_fname.format(
                    exp=args.experiment, sen_type=sen_type, word=args.word, avgTime=args.avgTime, avgTest=args.avgTest,
    ...
    fig.tight_layout()
    plt.savefig(fig_fname.format(
        exp=args.experiment, sen_type='both', word=args.word, avgTime=args.avgTime, avgTest=args.avgTest,
        perc=perc, fig_type='total-comb-perc-score-comp'
    ), bbox_inches='tight')
