...
if __name__ == '__main__':
    ...
    bar_fig.suptitle('Window Size Max Accuracy Comparison', fontsize=suptitlesize)
    bar_fig.subplots_adjust(top=0.85)
    ...
    bar_ax.legend(fontsize=legendfontsize)
    bar_ax.tick_params(labelsize=ticklabelsize)
    bar_fig.suptitle('Repetition Averaging Max Accuracy Comparison', fontsize=suptitlesize)
    bar_fig.subplots_adjust(top=0.85)
