...
if __name__ == '__main__':
    ...
    fig, ax = plt.subplots()
    h = ax.imshow(r2_plot, interpolation='nearest', aspect='auto', vmin=-0.5, vmax=0.5)
    ax.set_yticks(yticks_sens)
    ax.set_yticklabels(uni_reg)
    ax.set_ylabel('Sensors')
    ax.set_xticks(range(0, num_time, 250))
    ...
    fig, ax = plt.subplots()
    h = ax.imshow(r2_all_adj, interpolation='nearest', aspect='auto', vmin=-0.5, vmax=0.5)
    ax.set_yticks(yticks_sens)
    ax.set_yticklabels(uni_reg)
    ax.set_ylabel('Sensors')
    ax.set_xticks(range(0, num_time, 250))
    ...
    fig, ax = plt.subplots()
    h = ax.imshow(r2_word_adj, interpolation='nearest', aspect='auto', vmin=-0.5, vmax=0.5)
    ax.set_yticks(yticks_sens)
    ax.set_yticklabels(uni_reg)
    ax.set_ylabel('Sensors')
    ax.set_xticks(range(0, num_time, 250))
