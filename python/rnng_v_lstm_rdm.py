...
if __name__ == '__main__':
    ...
    fig.suptitle('{} {} kendall'.format(args.experiment, args.dist))
    fig.tight_layout()

    fig_mantel.suptitle('{} {} Mantel'.format(args.experiment, args.dist))
    fig_mantel.tight_layout()

    fig.savefig('RDM_kendall_scores_RvL_{exp}_{metric}_{tmin}_{tmax}_{word}.pdf'.format(exp=args.experiment, metric=args.dist, tmin=args.tmin, tmax=args.tmax, word=args.word))
    fig_mantel.savefig('RDM_mantel_scores_RvL_{exp}_{metric}_{tmin}_{tmax}_{word}.pdf'.format(exp=args.experiment, metric=args.dist,
