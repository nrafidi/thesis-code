...
if __name__ == '__main__':
    ...
    for i_hemi, hemi in enumerate(HEMIS):
        ...
        ax.text(-0.03, 1.01, string.ascii_uppercase[i_hemi], transform=ax.transAxes,
                size=axislettersize, weight='bold')
        ax.text(-0.03, -0.15, string.ascii_uppercase[i_hemi+2], transform=ax.transAxes,
                size=axislettersize, weight='bold')
        if i_hemi == 0:
    ...
    combo_fig.text(0.170, 0.06, 'Max', ha='center', fontsize=axislabelsize)
    combo_fig.text(0.85, 0.06, 'Max', ha='center', fontsize=axislabelsize)
    ...
    combo_fig.text(0.94, 0.6, 'Rank Accuracy', va='center',
