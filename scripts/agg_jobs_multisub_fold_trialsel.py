...
import os.path
import numpy as np
import batch_experiments_multisub_fold_trialsel as batch_exp
...
SAVE_FILE = '{dir}TGM-LOSO_multisub_long_{sen_type}_{word}_win{win_len}_ov{ov}_pr{perm}_' \
            ...
            'rsPerm{rsP}_nr{nr}_{mode}'


NEW_SAVE_FILE = '{dir}TGM-LOSO_multisub_long_{sen_type}_{word}_win{win_len}_ov{ov}_pr{perm}_' \
            'alg{alg}_adj-{adj}_avgTime{avgTm}_avgTest{avgTst}_ni{inst}_' \
            'rsPerm{rsP}_nr{nr}_{fold}'
