...
echo $force
python run_TGM_LOSO_EOS_multisub_subcv_fold.py --experiment $experiment --sen_type $sen_type --word $word --win_len $win_len --overlap $overlap \
--subject $subject --isPerm $isPerm --adj $adj --alg $alg --doTimeAvg $doTimeAvg --doTestAvg $doTestAvg --fold $fold \
