...
echo $force
python run_TGM_LOSO_multisub_fold_trialsel.py --experiment $experiment  --sen_type $sen_type --word $word --win_len $win_len --overlap $overlap \
--isPerm $isPerm --adj $adj --alg $alg --doTimeAvg $doTimeAvg --doTestAvg $doTestAvg --num_reps $num_reps --fold $fold \
