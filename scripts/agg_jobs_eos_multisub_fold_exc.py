...
import os.path
import numpy as np
import batch_experiments_eos_multisub_fold_exc as batch_exp
...
SAVE_FILE = '{dir}TGM-LOSO-EOS_multisub_exc_{sen_type}_{word}_win{win_len}_ov{ov}_pr{perm}_' \
            ...
            'rsPerm{rsP}_{mode}'
NEW_SAVE_FILE = '{dir}TGM-LOSO-EOS_multisub_exc_{sen_type}_{word}_win{win_len}_ov{ov}_pr{perm}_' \
            'alg{alg}_adj-{adj}_avgTime{avgTm}_avgTest{avgTst}_ni{inst}_' \
            'rsPerm{rsP}_{fold}'
